...
def WorldSelecter():
	n = input("Introduzca un número del 1 al 300, 0 para numero aleatorio \n")
	nombre_archivo = ("world_files/world_")

	if (n == 0):
		n = np.random.randint(1, 300)
		
	nombre_final = nombre_archivo + str(n) + ".world"
	directorio_actual = os.path.dirname(os.path.abspath(__file__))
	ruta_completa = os.path.join(directorio_actual, nombre_final)
	print(ruta_completa)
...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('world_path', default_value=WorldSelecter()	,
                          description='path'),
